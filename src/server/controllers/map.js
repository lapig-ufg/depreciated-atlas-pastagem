...
module.exports = function (app) {
    ...
    Map.indicatorsPastureCarbon = function (request, response) {
        ...
        client.query("SELECT SUM(area_ha), (SELECT SUM(pol_ha) FROM regions" + filtersRegions + ") as area_mun FROM " + layer +" " + filters, (err, res) => {
            var percentual_area_ha = ((res.rows[0].sum * 100) / res.rows[0].area_mun);
